...
fn main() {
    ...
    // // Display the image
    highgui::named_window("Gray image with reduced size", highgui::WINDOW_AUTOSIZE).expect("Failed to create window");
    ...
    imgcodecs::imwrite(output_path, &resized_image, &opencv::core::Vector::<i32>::new()).expect("Failed to save image");
